...
public class CoauthorFrame extends JFrame {
	...
	public interface callBack {
		void CoauthorListNotify(ArrayList<String> coauthorList) throws SQLException;
	}
	...
	public void showFrame() {
		...
		CoauthorFrame.this.setVisible(true);
	}

	public CoauthorFrame() {
	 ...
	 * Create the frame.
	 */
	public CoauthorFrame(AdjacencyList researchers, ArrayList<String> subscribe) {
		this.researchers = researchers;
		this.subscribe = subscribe;
		setTitle("Coauthor Search Frame");
		addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				try {
					m_callBack.CoauthorListNotify(CoauthorFrame.this.subscribe);
		...
		JLabel lblNewLabel_1 = new JLabel("Coauthor List");
		contentPane.add(lblNewLabel_1, "flowx,cell 4 0 2 1,alignx center");
			...
			public void mouseClicked(MouseEvent mouseEvent) {
				...
				if (mouseEvent.getClickCount() == 2) {
					...
					if (index >= 0) {
						...
						CoauthorFrame.subscribe.add(o.toString());
					}
				}
			}
		});
			...
			public void mouseClicked(MouseEvent mouseEvent) {
				...
				if (mouseEvent.getClickCount() == 2) {
					...
					if (index >= 0) {
						...
						CoauthorFrame.subscribe.remove(o);
					}
				}
			}
		});
